...
public class ReservaController {
	...
	public List<ReservaDTO> getResource() throws ServiceException, DaoException {
		...
		List<ReservaDTO> custList = restauranteService.findAllReservas().stream().map(b -> ReservaMapper.makeReservaDTO(b)).collect(Collectors.toList());
	...
	public @ResponseBody ResponseEntity<String> put(@Valid @PathVariable long localizador, @RequestBody Map<String, String> data) throws ServiceException, DaoException {
